...
// *********************** reset scores ************************
    ...
    // click event on reset season link
    $("#resetSeasonButKeepTeamInfo").click(function() {
      ...
      // reset all league score data from server
      for (var i = 0; i < league.length; i ++) {
        $.ajax({
          url: "/backliftapp/team/" + league[i].id,
          type: "PUT",
          ...
          success: function() {
            console.log("Updated team: " + i);
          },
          error: function() {
            console.log("Error updating team: " + i);
          }
        });
      }
